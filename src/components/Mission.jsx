      ...
      <div className="container px-5 py-4 mx-auto">
        ...
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            We aim to empower businesses with clean, scalable solutions that
            drive success. Our mission is to simplify complexity and deliver
            innovative digital experiences that create real impact.
          </p>
        </div>
